...
const CATEGORY_WEIGHTS: Record<string, Record<string, string[]>> = {
  teen: {
    F: ["뷰티", "여성의류", "여성가방", "여성주얼리", "여성액세서리", "레저", "문구/사무"],
    M: ["여성의류", "레저", "컴퓨터/디지털", "남성액세서리", "주방/생활", "문구/사무"],
  },
  twenties: {
    F: ["여성의류", "뷰티", "여성가방", "여성주얼리", "여성액세서리", "레저", "주방/생활"],
    M: ["레저", "컴퓨터/디지털", "남성가방", "남성액세서리", "주방/생활", "문구/사무"],
  },
  thirties: {
    F: ["여성가방", "여성의류", "뷰티", "주방/생활", "가구/인테리어", "여성주얼리"],
